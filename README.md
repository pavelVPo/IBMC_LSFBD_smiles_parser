...
4.  modifier -\> ambient:
    1.  bm_ibe -\> ambient: throw an error, atom is missing
    2.  bm_ibi -\> ambient: throw an error, atom is missing
    3.  bm_ire_2 -\> ambient: throw an error, atom is missing
    4.  bm_iri -\> ambient: throw an error, atom is missing
    5.  bm_iri_3 -\> ambient: throw an error, atom is missing
    6.  bm_tbe_2 -\> ambient: throw an error, atom is missing
    7.  bm_tbi -\> ambient: process further
    8.  bm_tre_2 -\> ambient: process further
    9.  bm_tre_4 -\> ambient: process further
    10. bm_tri -\> ambient: process further
    11. bm_tri_3 -\> ambient: process further
    12. l_ct -\> ambient: throw an error, atom is missing
    13. r_ct -\> ambient: throw an error, atom is missing
